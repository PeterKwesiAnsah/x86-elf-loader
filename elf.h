...
#define R_X86_64_PC32 2       // PC-relative 32-bit (S + A - P)
...
#define R_X86_64_GOTPCREL 9   // 32-bit signed PC-relative GOT
...
#define R_X86_64_IRELATIVE 37 // Indirect relative (B + A)
